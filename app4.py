...
try:
    ...
    st.success("CNN artifacts loaded.")
...
if st.button("Classify & Recommend"):
    if cnn_model and tokenizer and label_classes is not None:
        # Build user's sequence
        target_prop = item_props["property"].value_counts().index[0]  # most frequent
...
# Build numeric user features (example: total events, views, buys)
